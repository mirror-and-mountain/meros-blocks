...
import { removeClasses, StickyClasses } from '../hooks/fxClasses.js';
import { removeStyleVars, StickyStyleVars } from '../hooks/fxStyleVars.js';

export const StickyElementWrapper = createHigherOrderComponent(
    (BlockListBlock) => {
        return (props) => {
